...
\newcommand{\mySubtitle}{Using smart walkers \& Style\xspace}
\newcommand{\myDegree}{Project Report - Building the Internet of Things with P2P and Cloud Computing \xspace}
...
\newcommand{\mySupervisor}{Niels Olof Bouvin\xspace}
